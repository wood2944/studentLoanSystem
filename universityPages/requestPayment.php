...
$sql = "SELECT * FROM loanApplication WHERE `status` = 'Approved' AND paymentStatus = 'Approved by Student' ";
...
if($result = mysqli_query($conn, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        echo "There are no loans that are ready for payment request!";
    }
} else{
...
?>
        ...
        <form action="paymentStatus.php" method="post">
            ...
            <input type="hidden" name="paymentStatus" value="Awaiting Bank Payment" />
            <input type="submit" name="updateStatus" value ="Approve Loan!" />
        </form><br><br>



        <a href='universityLanding.php'>University Landing Page</a>
