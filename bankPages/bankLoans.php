...
echo "<h3 class='header'>Connection Successful, All loans for your bank.</h3> <br><br>";
...
$sql = "SELECT * FROM loanApplication WHERE distributingBank = '$bank';";
...
if($result = mysqli_query($conn, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        echo "There are no active loans or applications associated with your Bank!";
    }
} else{
